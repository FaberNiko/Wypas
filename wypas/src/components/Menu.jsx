	...
	let tabContent = (
		<>
			<div className={styles.menuItems}>
				...
				<MenuList title={"MEKSYK"}desc={"wołowina 200g/ bekon/ cheddar/ nachosy/ jalapeño/ sałata/ pikle/ pomidor/ cebula czerwona/ sos remulada/ sos sambal"}price={27}icons={[chili, chili]}></MenuList>
				<MenuList title={"EL DIABLO"}desc={"wołowina 200g/ bekon/ cheddar/ jalapeño/ sałata/ pikle/ pomidor/cebula czerwona/ prażona cebula/ sos sriracha/ sos habanero"}price={26}icons={[chili, chili, chili]}/>
				...
				<MenuList title={"VEGE BURAK"}desc={"kotlet buraczany/ rukola pomidor/ cebula czerwona/ nasiona słonecznika/ sos żurawinowy/ sos remulada"}price={23}icons={[vegan]}/>
	...
	return (
		<section id="menu" className={styles.menu}>
			...
			<div className={styles.buttons}>
				<button onClick={() => handleSelect("burgers")}>Burgery</button>
				<button onClick={() => handleSelect("trimmings")}>Dodatki</button>
			</div>
			{tabContent}
		</section>
	);
